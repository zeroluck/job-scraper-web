...
export function normalizeKeywordInsightsKey(
...
export function deserializeKeywordInsightsKey(
  key: string,
): KeywordInsightsQueryOptions {
  const parsed = JSON.parse(key) as {
    providers: string[];
    archetypes: string[];
    levels: string[];
    filterStatus: KeywordInsightsQueryOptions["filterStatus"];
    companies: string[];
    jobTitles: string[];
    provinces: string[];
